...
public class CreateOppertunities8 {
	...
	CreatingNewOpportunityPage hb = new CreatingNewOpportunityPage(driver);
	hb.Pers();
	hb.Amt();
	CreatingNewOpportunityPage up = new CreatingNewOpportunityPage(driver);
	up.Datebtn();
